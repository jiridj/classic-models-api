...
class TestOrderDetailAPI:
    ...
    def test_list_order_details_authenticated(self, authenticated_api_client, order_detail):
        ...
        assert response.data['results'][0]['ordernumber'] == order_detail.ordernumber.ordernumber
        assert response.data['results'][0]['productcode'] == order_detail.productcode.productcode
    ...
    @pytest.mark.django_db
    def test_retrieve_order_detail_authenticated(self, authenticated_api_client, order_detail):
        """Test retrieving a specific order detail when authenticated."""
        url = reverse('classicmodels:orderdetail-detail', kwargs={
    ...
    @pytest.mark.django_db
    def test_create_order_detail_authenticated(self, authenticated_api_client, order, product):
    ...
    @pytest.mark.django_db
    def test_create_order_detail_duplicate(self, authenticated_api_client, order_detail):
    ...
    @pytest.mark.django_db
    def test_create_order_detail_same_product_different_orders(self, authenticated_api_client, product, customer, order):
    ...
    @pytest.mark.django_db
    def test_update_order_detail_authenticated(self, authenticated_api_client, order_detail):
    ...
    @pytest.mark.django_db
    def test_partial_update_order_detail_authenticated(self, authenticated_api_client, order_detail):
    ...
    @pytest.mark.django_db
    def test_partial_update_order_detail_unauthenticated(self, api_client, order_detail):
    ...
    @pytest.mark.django_db
    def test_delete_order_detail_authenticated(self, authenticated_api_client, order_detail):
    ...
    @pytest.mark.django_db
    def test_order_detail_serializer_validation(self, authenticated_api_client, order, product):
    ...
    @pytest.mark.django_db
    def test_order_detail_decimal_precision(self, authenticated_api_client, order, product):
    ...
    @pytest.mark.django_db
    def test_order_detail_negative_quantity(self, authenticated_api_client, order, product):
    ...
    @pytest.mark.django_db
    def test_order_detail_negative_price(self, authenticated_api_client, order, product):
    ...
    @pytest.mark.django_db
    def test_order_detail_large_quantities(self, authenticated_api_client, order, product):
    ...
    @pytest.mark.django_db
    def test_order_detail_order_line_numbers(self, authenticated_api_client, order, product_line):
    ...
    @pytest.mark.django_db
    def test_order_detail_price_precision_rounding(self, authenticated_api_client, order, product_line):
    ...
    @pytest.mark.django_db
    def test_order_detail_very_small_prices(self, authenticated_api_client, order, product_line):
    ...
    @pytest.mark.django_db
    def test_order_detail_very_large_prices(self, authenticated_api_client, order, product_line):
        """Test handling of very large prices."""
        url = reverse('classicmodels:orderdetail-list')
        large_prices = ['99999999.99', '1000000.00', '5000000.50']  # Max value, 1 million, 5 million
    ...
    @pytest.mark.django_db
    def test_order_detail_multiple_products_same_order(self, authenticated_api_client, order, product_line):
    ...
    @pytest.mark.django_db
    def test_order_detail_calculated_total(self, authenticated_api_client, order, product):
        ...
        actual_total = response.data['quantityordered'] * Decimal(response.data['priceeach'])
        assert actual_total == expected_total

    @pytest.mark.django_db
    def test_order_detail_different_quantities_and_prices(self, authenticated_api_client, order, product_line):
    ...
    @pytest.mark.django_db
    def test_order_detail_pagination(self, authenticated_api_client, order, product_line):
    ...
    @pytest.mark.django_db
    def test_order_detail_relationships(self, authenticated_api_client, order_detail, order, product):

...
class TestProductLineAPI:
    ...
    def test_list_product_lines_authenticated(self, authenticated_api_client, product_line):
    ...
    @pytest.mark.django_db
    def test_retrieve_product_line_authenticated(self, authenticated_api_client, product_line):
        """Test retrieving a specific product line when authenticated."""
        url = reverse('classicmodels:productline-detail', kwargs={'productline': product_line.productline})
        response = authenticated_api_client.get(url)
    ...
    def test_retrieve_nonexistent_product_line(self, authenticated_api_client):
        ...
        url = reverse('classicmodels:productline-detail', kwargs={'productline': 'NONEXISTENT'})
        response = authenticated_api_client.get(url)
    ...
    @pytest.mark.django_db
    def test_create_product_line_duplicate(self, authenticated_api_client, product_line):
    ...
    @pytest.mark.django_db
    def test_update_product_line_authenticated(self, authenticated_api_client, product_line):
    ...
    @pytest.mark.django_db
    def test_partial_update_product_line_authenticated(self, authenticated_api_client, product_line):
        """Test partially updating a product line when authenticated."""
        url = reverse('classicmodels:productline-detail', kwargs={'productline': product_line.productline})
        data = {
            'textdescription': 'Partially updated description'
        }
    ...
    @pytest.mark.django_db
    def test_partial_update_product_line_unauthenticated(self, api_client, product_line):
    ...
    @pytest.mark.django_db
    def test_delete_product_line_authenticated(self, authenticated_api_client, product_line):
        """Test deleting a product line when authenticated."""
        url = reverse('classicmodels:productline-detail', kwargs={'productline': product_line.productline})
        response = authenticated_api_client.delete(url)
        
        assert response.status_code == status.HTTP_204_NO_CONTENT
        assert not ProductLine.objects.filter(productline=product_line.productline).exists()
    ...
    def test_product_line_large_data(self, authenticated_api_client):
        ...
        assert len(response.data['htmldescription']) == 4007  # 4000 + '<p></p>' (3 chars)
    ...
    def test_product_line_filtering(self, authenticated_api_client):
        ...
        ProductLine.objects.create(
            productline='Filter Line 1',
            textdescription='Contains keyword test'
        )
        ProductLine.objects.create(
            productline='Filter Line 2',
            textdescription='No keyword here'
        )

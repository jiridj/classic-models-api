...
class TestOfficeAPI:
    ...
    def test_retrieve_office_authenticated(self, authenticated_api_client, office):
        ...
        url = reverse('classicmodels:office-detail', kwargs={'officecode': office.officecode})
        response = authenticated_api_client.get(url)
    ...
    def test_retrieve_nonexistent_office(self, authenticated_api_client):
        ...
        url = reverse('classicmodels:office-detail', kwargs={'officecode': 'NONEXISTENT'})
        response = authenticated_api_client.get(url)
    ...
    @pytest.mark.django_db
    def test_partial_update_office_authenticated(self, authenticated_api_client, office):

...
class TestPaymentAPI:
    ...
    def test_list_payments_authenticated(self, authenticated_api_client, payment):
        ...
        assert response.data['results'][0]['customernumber'] == payment.customernumber.customernumber
    ...
    def test_retrieve_payment_authenticated(self, authenticated_api_client, payment):
        ...
        url = reverse('classicmodels:payment-detail', kwargs={
    ...
    @pytest.mark.django_db
    def test_create_payment_same_check_different_customers(self, authenticated_api_client, customer, employee):
    ...
    @pytest.mark.django_db
    def test_partial_update_payment_authenticated(self, authenticated_api_client, payment):
    ...
    def test_payment_check_number_formats(self, authenticated_api_client, customer):
        ...
        url = reverse('classicmodels:payment-list')
        check_numbers = ['CHK001', '123456', 'CHK-001', '123-456-789', 'CHK001A', '001234567890', 'CHK-001-2024']
    ...
    @pytest.mark.django_db
    def test_payment_multiple_payments_same_customer(self, authenticated_api_client, customer):
    ...
    @pytest.mark.django_db
    def test_payment_amount_precision_rounding(self, authenticated_api_client, customer):
    ...
    def test_payment_very_large_amounts(self, authenticated_api_client, customer):
        ...
        url = reverse('classicmodels:payment-list')
        large_amounts = ['99999999.99', '1000000.00', '5000000.50']  # Max value, 1 million, 5 million

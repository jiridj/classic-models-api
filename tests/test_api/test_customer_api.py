...
from classicmodels.models import Customer, Employee
...
class TestCustomerAPI:
    ...
    def test_retrieve_customer_authenticated(self, authenticated_api_client, customer):
        ...
        url = reverse('classicmodels:customer-detail', kwargs={'customernumber': customer.customernumber})
        response = authenticated_api_client.get(url)
    ...
    @pytest.mark.django_db
    def test_create_customer_duplicate_number(self, authenticated_api_client, customer, employee):
    ...
    @pytest.mark.django_db
    def test_partial_update_customer_authenticated(self, authenticated_api_client, customer):
        """Test partially updating a customer when authenticated."""
        url = reverse('classicmodels:customer-detail', kwargs={'customernumber': customer.customernumber})
        data = {
            'customername': 'Partially Updated Customer',
            'phone': '+1-555-7777'
        }
    ...
    def test_delete_customer_authenticated(self, authenticated_api_client, customer):
        ...
        assert not Customer.objects.filter(customernumber=customer.customernumber).exists()
